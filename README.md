# javascript-data-selfie
app that allows you to submit an image of your self along with your geolocation, making use of 
node.js and node module "express" to create a webserver
